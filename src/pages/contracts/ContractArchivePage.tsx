      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Daftar kontrak yang telah dibatalkan, ditolak, atau berakhir.
          </p>
        </div>
        <button
          onClick={() => navigate('/contracts')}
          className="flex items-center gap-2 px-4 py-2 text-sm rounded-lg border bg-white hover:bg-gray-50 transition-colors font-medium shrink-0 text-gray-700 shadow-sm"
        >
