...
import { ToolbarBtn } from "./ToolbarComponents";
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-1 p-3 bg-white border border-gray-200 shadow-xl rounded-lg z-[100] min-w-[200px]">
          <div className="mb-2 pb-2 border-b border-gray-100">
            <p className="text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">Insert Table</p>
                  ...
                  return (
                    <div
                      ...
                      className={`w-3.5 h-3.5 border transition-colors cursor-pointer ${
                        isActive ? "bg-emerald-500 border-emerald-600" : "bg-gray-50 border-gray-200 hover:border-emerald-300"
                      }`}
                    />
                  );
                })
          ...
          {isTableActive && (
            <div className="space-y-1">
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1 mt-2">Table Actions</p>
